...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/mnt/share_disk/liuman/SD-HM/SD-HM-V0.4.0",
        required=False,
    ...
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="/mnt/share_disk/liuman/datas/data/",
        help=(
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/mnt/share_disk/liuman/model/SD-HMft0.1.0",
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                """
                将输入图像通过VAE的编码器部分转换为潜在空间latent space,
                然后从潜在分布中进行采样,
                得到潜在表示 latents.
                """
                ...
                # 创建一个与 latents 相同形状的张量，其中的值是从标准正态分布中采样得到的随机噪声
