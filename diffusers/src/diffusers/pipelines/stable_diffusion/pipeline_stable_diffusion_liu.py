...
class StableDiffusionPipelineLiu(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromCkptMixin):
    r"""
    ...
    def __call__(
        ...
        # 6-1. Prepare added time ids & embeddings
        # prompt = "7:00, a street at night with a green light on the street and a street light on the side of the road"
        ...
        # if do_classifier_free_guidance:
            ...
            # image_times = torch.cat([image_times, image_times], dim=0)
